...
mainGETGroupsDJSuccess.setEntity(new StringEntity(mainGETGroupsDJContent
		...
		JSONObject PUTNicknameSuccessContent = new JSONObject().put("success",
				true);
		PUTNicknameSuccess = new BasicHttpResponse(new ProtocolVersion("HTTP",
				1, 1), HttpStatus.SC_OK, "OK");
		PUTNicknameSuccess.setEntity(new StringEntity(PUTNicknameSuccessContent
				.toString()));
